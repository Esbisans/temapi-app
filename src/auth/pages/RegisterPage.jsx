                        ...
                        <div className='flex justify-start'>
                            ...
                            <div className='relative'>
                                <input 
                                    ...
                                    className='max-w-full w-full h-12 p-4 rounded-xl content-center placeholder:text-black placeholder:opacity-40 text-opacity-70 focus:outline-none transition duration-200 ease-out text-black bg-gray-50 border-opacity- focus:ring focus:ring-indigo-100 focus:bg-opacity-0' 
                                />
                                {errors.name && (
