...
export const ContactsBar = () => {
  ...
  return (
    <aside
        className="grow h-[100vh] xs:w-full md:w-[18.125rem] xs:px-5 md:p-0 flex flex-col overflow-visible transition-all duration-500 xs:grow-1 md:grow-0 xs:overflow-y-scroll md:overflow-visible scrollbar-hidden"
        onClick={onclick}
        >
